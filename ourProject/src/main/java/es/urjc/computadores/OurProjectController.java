...
public class OurProjectController {
	...
	public void init() {
		...
		if (userRepo.findAll().isEmpty()) {
			...
			Goal g2 = new Goal(p2, 10.0, "Claves juego");
			Goal g3 = new Goal(p2, 30.0, "DLC");
			Goal g4 = new Goal(p2, 85.0, "Quedada con desarrolladores");
			Goal g5 = new Goal(p2, 100.0, "Todo el contenido del juego y avances");
