...
mysql --host mysqlmaster -uroot -p$MYSQL_MASTER_PASSWORD -e 'CREATE DATABASE our_project';

mysql --host mysqlmaster -uroot -p$MYSQL_MASTER_PASSWORD -e 'SHOW DATABASES';

mysql --host mysqlslave -uroot -p$MYSQL_MASTER_PASSWORD -e 'SHOW DATABASES';
